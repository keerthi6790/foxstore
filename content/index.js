...
{
    console.log('entered');
    setTimeout(loaderChnage,1000);
}
function loaderChnage(){
    console.log('entered');
...
{
    console.log('e');
    document.getElementById(`bestimage${i}`).src=products[i].img;
    document.getElementById(`bestname${i}`).innerText=products[i].name;
    document.getElementById(`bestprice${i}`).innerText=products[i].price;
}
// product assign
...
function addcart(n)
{
    ...
    cart.push(products[n].name);
    localStorage.setItem(cart,products[n].name);
}
function locate()
{
